        ...
        <>
            <div className={styles.main}>
                ...
                <div className={styles.reviews}>
                    {new Array(5).fill().map((_, index) => <Star
                        className={cs({[styles.star_disabled]: activeItem.rating <= index})}/>
                    )}
                    <span className={styles.review}>{activeItem.reviews} review{activeItem.reviews > 1 && "s"}</span>
                </div>
