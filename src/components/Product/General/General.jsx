        ...
        <div className={styles.data}>
            <div className={cs(styles.block, styles.block_down)}>
                ...
                <div className={styles.memory}>
                    <Button textSize='middle' variant='outlined'
                            className={`${styles.memory_btn} ${styles.memory_btn_active}`}>125 GB</Button>
                    <Button textSize='middle' variant='outlined' className={styles.memory_btn}>125 GB</Button>
                    <Button textSize='middle' variant='outlined' className={styles.memory_btn}>125 GB</Button>
                    <Button textSize='middle' variant='outlined' className={styles.memory_btn}>125 GB</Button>
                </div>
            </div>
            <div className={cs(styles.block, styles.block_up)}>
                ...
                <div className={styles.cart}>
                    <Icon type='like'/>
                    <Icon type='compare'/>
                    <Button className={styles.cart_btn} icon={<Cart/>}>Add to Cart</Button>
                </div>
            </div>
            <CardRow/>
